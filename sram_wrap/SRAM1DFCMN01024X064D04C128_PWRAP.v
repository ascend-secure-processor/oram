...
input wire TESTEN,
input wire [63:0] TBW,
input wire [63:0] TDIN,
output wire [63:0] TDOUT,
...
// set_dont_touch find("cell", "*bufout*")
// synopsys dc_script_end

wire [63:0] DOUT_Pre;
genvar i;
generate for (i = 0; i < 64; i = i + 1) begin:BUF
	BUF_X5B_A9TU bufout(.Y(DOUT[i]), .A(DOUT_Pre[i]));
end endgenerate

SRAM1DFCMN01024X064D04C128 ibmsram (
.ARWY(),
.AB0(AB[0]),
.AC0(AC[0]),
.AC1(AC[1]),
